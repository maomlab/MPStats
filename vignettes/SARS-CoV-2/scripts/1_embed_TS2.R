...
cell_features_2M <- tibble::tibble(plate_id = c("TS2PL1", "TS2PL2", "TS2PL3")) %>%
    ...
    dplyr::do({
        ...
        arrow::read_parquet(
            paste0("~/opt/MPStats/vignettes/SARS-CoV-2/product/covid19cq1_SARS_", plate_id, "_Cell_MasterDataTable.parquet")) %>%
            dplyr::mutate_at(
...
system("
        ...
        /home/ubuntu/anaconda3/envs/sextonlab/bin/python \\
            ...
            --dataset /home/ubuntu/opt/MPStats/vignettes/SARS-CoV-2/product/covid19cq1_SARS_TS2_2M_Cell_MasterDataTable.parquet \\
...
cell_features <- dplyr::bind_cols(
    arrow::read_parquet(
        file = "product/covid19cq1_SARS_TS2_plate_scaled_Cell_MasterDataTable.parquet"),
    arrow::read_parquet(
